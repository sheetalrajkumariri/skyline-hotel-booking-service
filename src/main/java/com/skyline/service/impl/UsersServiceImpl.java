...
public class UsersServiceImpl implements UsersService {
    ...
    public UsersResponse createUser(UsersRequest request) {
        ...
        Role role = roleRepository.findRoleByName("USER")
                .orElseThrow(() ->
                        new NotFoundException("Role not found with name: " +"User"));
    ...
    public List<UsersResponse> findAllUser(int page, int size, String sortBy, String sortDir) {
        ...
        List<UsersResponse> responseList = customerPage.getContent()
                .stream()
                .map(users -> modelMapper.map(users, UsersResponse.class))
                .toList();
